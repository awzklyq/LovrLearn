...
function SceneNode3D:bindDirectionLight(light)
    ...
    local width = RenderSet.getShadowMapSize()--love.graphics.getPixelWidth() -- lovr.system.getWindowWidth() * 2
    local height = RenderSet.getShadowMapSize()--love.graphics.getPixelHeight()--lovr.system.getWindowHeight() * 2
